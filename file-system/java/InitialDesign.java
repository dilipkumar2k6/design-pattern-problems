...
class File {
    ...
    public void ls() {
        System.out.println(InitialDesign.compositeBuilder + name);
    }
}
...
class Directory {
    ...
    public void ls() {
        System.out.println(InitialDesign.compositeBuilder + name);
        InitialDesign.compositeBuilder.append("   ");
        ...
        InitialDesign.compositeBuilder.setLength(InitialDesign.compositeBuilder.length() - 3);
    }
}
